    ...
    while True:
        ...
        try:
            ...
            try:
                ...
                # tree_ap.configure(columns=headers, displaycolumns=("BSSID", "channel", "Privacy", "Authentication", "ESSID")) # tohle je druhy zpusob, jak zobrazit jenom nektery sloupce - TO TEST
            ...
            try:
                ...
                for row in reader:
                    selected_row = [row[i] for i in selected_columns if i < len(row)]
                    tree_cl.insert('', tk.END, values=selected_row, tags=selected_row[1].strip())
