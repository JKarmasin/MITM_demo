...
def tree_cl_selected(Event):
    ...
    target_ap.configure(text=item_values[1].strip())
    target_cl.configure(text=item_values[0].strip())
...
interface_frame.pack(padx=10,pady=5, fill='x')  # WTF Todle není rozatežný po celé šířce?!
