...
#global output_airodump
          # ukončení threadu se čtením ze souboru pro full airodump
...
def start_airodump_full():
    ...
    # tady bylo capture
    airodump_process = subprocess.Popen(command, shell=True, stderr=subprocess.PIPE, preexec_fn=os.setsid)
...
frame_t1 = tk.Frame(root)
frame_t1.pack(expand=True, fill='both')

#frame_t1 = Frame(main_frame)
